			...
			<div class="container">
				...
				<section class="box-1">
					<div class="caption">
						...
						<p>Foundations for <br>a Well-Lived Life</p>
					</div>
				</section>
				...
				<section class="box-2">
					<div class="box-data">
						<h2>FOOTWEAR FIRST</h2>
						<p>Our style philosophy starts from the ground up.</p>
						<p>Building a timeless wardrobe around classic, versatile pieces that you can dress up or down, transcending trends and giving you a foundation of effortless style that lasts.</p>
